...
- **Engineer -** where I learned how to solve problems with technology, working with people to understand the needs, opportunities, and pain points.
- **Engineering Manager -** where I had the privilege of cultivating the growth of others, supporting them in their careers, and creating a successful team.
- **Consultant -** where I was able to serve customers through active listening, partnership, and my technical expertise.
- **Agile Coach -** at the team, organization, and enterprise levels and helped companies adapt their practices, mindsets, processes, and culture to deliver real value to their customers.
- **Teacher -** where I was able to support the ongoing growth of students, colleagues, and clients through facilitation, adult learning theory, instructional design, and outcome-focused learning.
- **Program Manager (Learning & Development, Operations, Leadership Development) -** where I was able to own programs from ideation to delivery and continuous improvement, leading to real impact and successful outcomes for organizations and people.
